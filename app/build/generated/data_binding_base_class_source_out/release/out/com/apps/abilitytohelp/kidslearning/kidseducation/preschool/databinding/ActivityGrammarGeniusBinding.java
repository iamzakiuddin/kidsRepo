...
public final class ActivityGrammarGeniusBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RecyclerView grammarErrorsListView;
  ...
  private ActivityGrammarGeniusBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout backBtn, @NonNull RecyclerView grammarErrorsListView,
    ...
    this.grammarErrorsListView = grammarErrorsListView;
  ...
  @NonNull
  public static ActivityGrammarGeniusBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGrammarGeniusBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_grammar_genius, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGrammarGeniusBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.grammarErrorsListView;
      RecyclerView grammarErrorsListView = ViewBindings.findChildViewById(rootView, id);
      if (grammarErrorsListView == null) {
        break missingId;
      }
      ...
      return new ActivityGrammarGeniusBinding((ConstraintLayout) rootView, backBtn,
          grammarErrorsListView, imgBackButton, llAdView, llAdViewFacebook, loading, rltTop,
          searchBtn, searchField, txtTitleSubHome);
    }
