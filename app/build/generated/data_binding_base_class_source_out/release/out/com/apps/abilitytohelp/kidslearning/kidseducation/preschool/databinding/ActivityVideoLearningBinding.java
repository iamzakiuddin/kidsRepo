...
public final class ActivityVideoLearningBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvVideoCategory;

  @NonNull
  public final TextView txtTitleSubHome;

  private ActivityVideoLearningBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull RelativeLayout rltTop, @NonNull RecyclerView rvVideoCategory,
    ...
    this.rltTop = rltTop;
    this.rvVideoCategory = rvVideoCategory;
  ...
  public static ActivityVideoLearningBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rvVideoCategory;
      RecyclerView rvVideoCategory = ViewBindings.findChildViewById(rootView, id);
      if (rvVideoCategory == null) {
        break missingId;
      }
      ...
      return new ActivityVideoLearningBinding((LinearLayout) rootView, backBtn, imgBackButton,
          llAdView, llAdViewFacebook, rltTop, rvVideoCategory, txtTitleSubHome);
    }
