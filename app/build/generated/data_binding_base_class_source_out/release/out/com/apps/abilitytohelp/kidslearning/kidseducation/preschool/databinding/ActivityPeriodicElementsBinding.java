...
public final class ActivityPeriodicElementsBinding implements ViewBinding {
  ...
  private ActivityPeriodicElementsBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ProgressBar loading, @NonNull RecyclerView periodicElementsList,
      @NonNull RelativeLayout rltTop, @NonNull TextView txtTitleSubHome) {
  ...
  public static ActivityPeriodicElementsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPeriodicElementsBinding((ConstraintLayout) rootView, backBtn,
          imgBackButton, llAdView, llAdViewFacebook, loading, periodicElementsList, rltTop,
          txtTitleSubHome);
    }
