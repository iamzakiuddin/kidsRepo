...
public final class ActivityWordImageBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RecyclerView imagesListView;
  ...
  private ActivityWordImageBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout backBtn, @NonNull RecyclerView imagesListView,
  ...
  @NonNull
  public static ActivityWordImageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityWordImageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_word_image, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityWordImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imagesListView;
      RecyclerView imagesListView = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityWordImageBinding((ConstraintLayout) rootView, backBtn, imagesListView,
          imgBackButton, llAdView, llAdViewFacebook, loading, rltTop, searchBtn, searchField,
          txtTitleSubHome);
    }
