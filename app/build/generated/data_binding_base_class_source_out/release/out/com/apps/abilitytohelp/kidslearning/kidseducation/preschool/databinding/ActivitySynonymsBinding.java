...
public final class ActivitySynonymsBinding implements ViewBinding {
  ...
  private ActivitySynonymsBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout backBtn,
      ...
      @NonNull RecyclerView synonymsListView, @NonNull TextView txtTitleSubHome) {
  ...
  public static ActivitySynonymsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySynonymsBinding((ConstraintLayout) rootView, backBtn, imgBackButton,
          llAdView, llAdViewFacebook, loading, rltTop, searchBtn, searchField, synonymsListView,
          txtTitleSubHome);
    }
