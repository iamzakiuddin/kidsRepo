...
public final class ActivityVideoLearningBinding implements ViewBinding {
  ...
  private ActivityVideoLearningBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull LinearLayout llAdViewFacebook, @NonNull RecyclerView rvVideoCategory,
  ...
  public static ActivityVideoLearningBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityVideoLearningBinding((LinearLayout) rootView, imgBackButton, llAdView,
          llAdViewFacebook, rvVideoCategory, txtTitleSubHome);
    }
