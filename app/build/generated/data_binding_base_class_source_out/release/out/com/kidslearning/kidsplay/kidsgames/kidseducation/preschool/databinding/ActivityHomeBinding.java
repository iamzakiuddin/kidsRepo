...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  private ActivityHomeBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgBackButton,
      @NonNull ImageView imgSoundOff, @NonNull ImageView imgSoundOn,
      @NonNull RelativeLayout llAdView, @NonNull LinearLayout llAdViewFacebook,
      @NonNull RecyclerView rvHomeCategories, @NonNull TextView txtExamTitle,
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHomeBinding((LinearLayout) rootView, imgBackButton, imgSoundOff,
