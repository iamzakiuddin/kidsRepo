...
public final class ActivityExamQuestionBinding implements ViewBinding {
  ...
  private ActivityExamQuestionBinding(@NonNull LinearLayout rootView, @NonNull FrameLayout flBootom,
      @NonNull ImageView iVQuestion, @NonNull ImageView imgBackButton,
      @NonNull ImageView imgBtnNext, @NonNull ImageView imgBtnPrev,
  ...
  public static ActivityExamQuestionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityExamQuestionBinding((LinearLayout) rootView, flBootom, iVQuestion,
