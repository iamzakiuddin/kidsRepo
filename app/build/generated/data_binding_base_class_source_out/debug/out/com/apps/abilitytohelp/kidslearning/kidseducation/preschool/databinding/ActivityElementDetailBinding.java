...
public final class ActivityElementDetailBinding implements ViewBinding {
  ...
  private ActivityElementDetailBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView atomicRadius, @NonNull LinearLayout backBtn, @NonNull TextView block,
      ...
      @NonNull ImageView imgBackButton, @NonNull TextView ionRadius,
      @NonNull TextView ionizationEnergy, @NonNull TextView isotopes,
  ...
  public static ActivityElementDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityElementDetailBinding((ConstraintLayout) rootView, affinity, atomicMass,
          atomicNumber, atomicRadius, backBtn, block, bondingType, crystalStructure, density,
          electronicConfiguration, elementName, group, groupBlock, histroy, imgBackButton,
          ionRadius, ionizationEnergy, isotopes, llAdView, llAdViewFacebook, magneticOrdering,
          meltingPoints, minerals, molarHeatCapacity, negativity, oxidationStates, period, rltTop,
          speedOfSound, standardState, txtTitleSubHome, vanDerWaalsRadius, yearOfDiscovers);
    }
