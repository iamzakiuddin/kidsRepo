...
public final class ActivitySubBinding implements ViewBinding {
  ...
  private ActivitySubBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout backBtn,
  ...
  public static ActivitySubBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySubBinding((LinearLayout) rootView, backBtn, imgBackButton, llAdView,
          llAdViewFacebook, rltTop, rvSubHome, txtTitleSubHome);
    }
