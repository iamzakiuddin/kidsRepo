...
public final class ActivityListVideoBinding implements ViewBinding {
  ...
  private ActivityListVideoBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout backBtn,
      @NonNull ImageView imgBackButton, @NonNull RelativeLayout llAdView,
      @NonNull LinearLayout llAdViewFacebook, @NonNull RelativeLayout rltTop,
  ...
  public static ActivityListVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityListVideoBinding((LinearLayout) rootView, backBtn, imgBackButton, llAdView,
          llAdViewFacebook, rltTop, rvVideoList, txtTitleSubHome);
    }
