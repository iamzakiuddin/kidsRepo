...
public final class ActivityExamListenGuessBinding implements ViewBinding {
  ...
  public static ActivityExamListenGuessBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityExamListenGuessBinding((LinearLayout) rootView, flBootom, iVQuestion,
          imgBackButton, imgBtnNext, imgBtnPrev, llAdView, llAdViewFacebook, llQuestion, rltRecycle,
